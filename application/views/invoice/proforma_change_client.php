...
<html lang="en">
    ...
    <body>
        ...
        <form action="<?php echo base_url('invoices/updateProformaClient'); ?>" method="post" id="save_test">
            <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
           
            <input type="hidden" name="proforma_invoice_id" value="<?php echo $invoice_id; ?>">
