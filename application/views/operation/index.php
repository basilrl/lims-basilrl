<script src="<?php echo base_url(); ?>public/js/operation.js"></script>
<main class="main">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-9">
                <div class="row">
                    <div class="col-sm-6">
                        <input type="text" class="search form-control form-control-sm" placeholder="Search by controller or function name" name="" id="">
                    </div>
                    <div class="col-sm-4">
...
<script>
    $(document).ready(function() {
      ...
      $(document).on('click','.log_view',function() {
        ...
        $.ajax({
          type: 'post',
          url: url + 'operation/get_operation_log',
          data: {
            _tokken: _tokken,
