    ...
    <div class="bg_image">
        ...
        <htmlpagefooter name="myFooter">
            ...
            <table style="width: 100%;text-align:center;font-size:9px;font-family:calibri;text-transform:uppercase;">
                ...
                <tr class="footer">
                    <td style="opacity:0.3;"><b> GC-DXB/REC-56-B</b></td>
                        ...
                        <tbody>
                            ...
                            foreach ($test_data as $td) {  ?>
                                <tr>
                                    ...
                                    <td><?php echo $td->test_display_method; ?></td>
            ...
            <?php if ($record_finding_data != '') { ?>
                <div class="sample_image1 noheader" style="page-break-inside: auto !important;font-size:10px;text-transform:uppercase;">
                    <?php foreach ($record_finding_data as $key => $Data) { ?>
                        <div style="text-transform:uppercase;width:100%;border-collapse:collapse;font-size:10px;margin:0 auto;font-weight:bold;" border="1">
                            <?php echo $Data['sequence_no']; ?>. <?php echo $Data['test_display_name']; ?> - <?php echo $Data['test_display_method']; ?>
                        </div>
