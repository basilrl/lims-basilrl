...
<body>
    ...
    <div class="bg_image">
        ...
        <htmlpagefooter name="myFooter">
            ...
            <table style="width: 100%;text-align:center;font-size:9px;font-family:calibri;text-transform:uppercase;">
                <tr>
                    <td colspan="2"><b> GEO-CHEM MIDDLE EAST</b></td>
                </tr>
                <tr>
                    <td colspan="2">Plot No. 18-0, Dubai Investment Park II, Affection Plan # 597-22, EBC Warehouse # 6. Dubai. UAE. <br>
                        E-mail :<a href="cps.dubai@basilrl.com"> cps.dubai@basilrl.com </a> Web :<a href="https://basilrl.com"> https://basilrl.com</a>
                    </td>
                </tr>
                <tr class="footer">
                    <td style="opacity:0.3;"><b> GC-DXB/REC-56-C</b></td>
        ...
        <?php if ($image_sample) { ?>
            <div class="" style="text-transform:uppercase;">
                <h3 style="text-align: center;">SAMPLE PHOTO</h3>
    ...
    <?php if ($image_sample) { ?>
        ...
        <?php } else { ?>
            ...
            <table style="text-transform:uppercase;font-size:10px;width:100%;margin:0 auto;text-align:right;border-collapse:collapse;padding:5px;">
                <tr>
                    <td>Sample Received Date : <?php echo date("d/m/y", strtotime($report_data->received_date)); ?></td>
                </tr>
                <tr>
                    <td>Testing Period : <?php echo date("d/m/y", strtotime($report_data->received_date)); ?> to <?php echo date("d/m/y", strtotime($report_data->generated_date)); ?></td>
                </tr>
            </table>
            ...
            <table>
                <tr>
                    <td>
                        <table style="text-transform:uppercase;font-size:10px;width:55%;text-align:left;border-collapse:collapse;padding:5px;display:inline-block;border:none; ">
                            <!-- <tr>
                <th style="font-style:italic;text-align:left;" colspan="3">Applicant Details</th>
                            ...
                            <tr>
                                ...
                                <td style="text-align: left;"><?php echo $report_data->contact_name; ?></td>
                            </tr>
                            <tr>
                                <td style="text-align: left;">Address :</td>

                                <td style="text-align: left;"><?php echo $report_data->address; ?></td>
                            </tr>
                            <!-- <tr>
                <td style="text-align: left;">Contact Details</td>
              
                <td style="text-align: left;"><?php echo $report_data->customer_name; ?></td>
            </tr> -->
                        </table>
                    </td>
                    <td>
                        <table style="text-transform:uppercase;font-size:10px;width:40%;text-align:center;border-collapse:collapse;padding:5px;display:inline-block;border:none; " border="1">
                            <tr>
                                <td colspan="2">Mandatory Item</td>
                                <td colspan="2">Product Performance Item</td>
                            </tr>
                            <tr>
                                <td></td>
                                <td>Pass</td>
            ...
            <div style="width: 100%;font-style:italic;font-size:10px;"><b> Sample not drawn by Geo-Chem Middle East L.L.C.</b></div>
            <div style="width: 100%;font-style:italic;font-size:10px;"> Sample Description as declared</div>
            <table style="text-transform:uppercase;font-size:10px;padding:5px;width:100%;margin:0 auto;text-align:left;border-collapse:collapse; ">
                <tr>
                    <td style="text-align: left;">As Client</td>
            ...
            <br><br>
            <table style="text-transform:uppercase;font-size:10px;padding:5px;width:100%;margin:0 auto;border-collapse:collapse;border:1px solid black; ">
            ...
            <table style="width:95%;border-collapse:collapse;text-align:left;font-size:10px;margin:0 auto;">
                ...
                <tr>
                    ...
                    <td> F = Below buyer’s Requirement</td>
                </tr>
                <tr>
            ...
            <?php if ($report_data->remark) { ?>
                <table style="width:95%;border-collapse:collapse;text-align:left;font-size:10px;margin:0 auto;">
                    ...
                    <tr>
                        <td style="width: 50%;text-align:left;">Remarks: </td>
                    </tr>
                    <tr>
                        <td style="width: 50%;text-align:left;font-style:italic;"><?php echo trim(html_entity_decode($report_data->remark)); ?></td>
                    </tr>
                </table>
            <?php } ?>
            <?php if ($record_finding_data != '') { ?>
                <div style="font-size:10px;text-transform:uppercase;">
                    <?php foreach ($record_finding_data as $key => $Data) { ?>
                        <table style="text-transform:uppercase;width:100%;border-collapse:collapse;font-size:10px;margin:0 auto;" border="1">
                            <tr>
                                <td style="text-align:left;padding:6px;"><?php echo $Data['sequence_no']; ?>. <?php echo $Data['test_display_name']; ?> ( <?php echo $Data['test_display_method']; ?> )</td>
                            </tr>
                        </table>
