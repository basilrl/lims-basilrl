                    ...
                    <div class="col-md-12">
                        <div class="card">
                                ...
                                <table class="table table-sm table-hovered text-center text-secondary">
                                    <thead class="thead-light">
                                        <tr>
                                            ...
                                            <th>Service Type</th>
                                            <th>Due Date</th>
                                            <?php if ( (exist_val('Manage_lab/Lab_completion', $this->session->userdata('permission'))) || (exist_val('Manage_lab/SaveAssignTest', $this->session->userdata('permission'))) ) { ?> <!-- added by millan on 23-02-2021 -->
                                                <th>Action</th>
                                            <?php } ?>
                                        </tr>
                                    </thead>
                                    ...
                                    <tbody>
                                        ...
                                        ?> <?php foreach ($accepted_sample as $AS) : ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo change_time($AS->received_date,$this->session->userdata('timezone')); ?></td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php if (($AS->sample_test_ids ==  $AS->test_status)) { ?>
                                                            ...
                                                            <?php if (exist_val('Manage_lab/Lab_completion', $this->session->userdata('permission'))) { ?> <!-- added by millan on 23-02-2021 -->
                                                        ...
                                                        <?php } else { ?>
                                                            <?php if (exist_val('Manage_lab/SaveAssignTest', $this->session->userdata('permission'))) { ?> <!-- added by millan on 23-02-2021 -->
                            ...
                            <div class="card-footer">
                                <div class="row">
                                    <div class="col-sm-4"> <?php echo $links; ?></div>
                                    <div class="col-md-4"></div>
                                    <div class="col-md-4"><?php echo $result_count;?></div>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    $('document').ready(function() {
        ...
        $('.assign_test').click(function() {
            $('#analysis').empty();
            $('#analysis').append($('<option></option>').attr({ disabled: 'disabled', selected: 'selected' }).text('Select Analyst'));
