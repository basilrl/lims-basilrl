...
<body>
    ...
    <div class="bg_image">
                        ...
                        <?php if ($signature1) { ?>
                            <td style="width:50%;float:left;">
                                <table style="width:100%">
                                    ...
                                    <tr>
                                        <td style="text-align:left;"><img src="<?php echo $signature1; ?>" width="30%" alt=""></td>
                                    </tr>
                                    <tr>
                    ...
                    <?php if (!empty($Data['test_type'])) { ?>
                        ...
                        <table style="width: 100% !important;border-collapse: collapse;margin:0;padding:0;">
                            <?php if ($Data['nabl_detail'] != '' && $Data['nabl_detail'] != NULL) { ?>
                                <tr>
                                    <td style="width: 100%;" class=""><?php echo html_entity_decode(base64_decode($Data['nabl_detail'])); ?></td>
                                </tr>
                            <?php } ?>
                            <?php if ($Data['nabl_remark'] != '' && $Data['nabl_remark'] != NULL) { ?>
                                <tr>
                                    <td style="width: 100%;" class=""><?php echo html_entity_decode(base64_decode($Data['nabl_remark'])); ?></td>
                                </tr>
                            <?php } ?>
                        </table>
                        <table style="width:100% !important;border-collapse: collapse;margin:0;padding:0;">
                            <?php if ($Data['non_nabl_detail'] != '' && $Data['non_nabl_detail'] != NULL) { ?>
                                <tr>
                                    <td style="width: 100%;" class=""><?php echo html_entity_decode(base64_decode($Data['non_nabl_detail'])); ?></td>
                                </tr>
                            <?php } ?>
                            <?php if ($Data['non_nabl_remark'] != '' && $Data['non_nabl_remark'] != NULL) { ?>
                                <tr>
                                    <td style="width: 100%;" class=""><?php echo html_entity_decode(base64_decode($Data['non_nabl_remark'])); ?></td>
                                </tr>
                            <?php } ?>
                        </table>
                    <?php } ?>
                                    ...
                                    <table style="width:100%;border-collapse:collapse;text-align:center!important;cellspacing:2px;">
                                        <?php foreach ($Data['images'] as $key => $value) { ?>
                                            <tr>
                                                ...
                                                <td style="text-align: center;"><img src="<?php echo $value['image_path']; ?>" alt="" style="border:1px solid #333;width:300px;"></td>
        ...
        <div class="noheader chapter2" style="page-break-inside: auto !important; font-size: 4.8px;">
