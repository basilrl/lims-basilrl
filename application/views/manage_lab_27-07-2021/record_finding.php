                ...
                <table class="table">
                  <thead class="thead-light">
                    <tr>
                      ...
                      <?php if ( (exist_val('Manage_lab/open_record_finding', $this->session->userdata('permission'))) || (exist_val('Manage_lab/mark_completed', $this->session->userdata('permission'))) || (exist_val('Manage_lab/edit_record_finding', $this->session->userdata('permission'))) ) { ?> <!-- added by millan on 23-02-2021 -->
                        ...
                        <tr>
                          ...
                          <?php if($item->trf_buyer != 0 && $item->buyer_active == 'Active'){?>
                            ...
                            <?php if (($item->sample_test_status == 'Record Enter Done' || $item->sample_test_status == 'Retest') && $item->record_finding_id != NULL) { ?>
                              <?php if (exist_val('Manage_lab/mark_completed', $this->session->userdata('permission'))) { ?> <!-- added by millan on 23-02-2021 -->
                              ...
                              <?php } ?>
                              <?php if (exist_val('Manage_lab/edit_record_finding', $this->session->userdata('permission'))) { ?> <!-- added by millan on 23-02-2021 -->
                              ...
                              <?php } ?>
                            <?php } else { ?>
                              <?php if (exist_val('Manage_lab/open_record_finding', $this->session->userdata('permission'))) { ?> <!-- added by millan on 23-02-2021 -->
