...
<tr><td style="width: 12%;"></td><td >*= Not Provided, </td> <td>NA = Not Applicable</td></tr>
    ...
    <!-- <div style="padding:5px;font-size:10px;;">REMARKS : <?php //echo trim(html_entity_decode($report_data->remark)); ?></div> -->
    ...
    <?php if ($record_finding_data != '') { ?>
        <div class="sample_image1 noheader" style="page-break-inside: auto !important;font-size:10px;text-transform:uppercase;">
            <?php foreach ($record_finding_data as $key => $Data) { ?>
                ...
                <tr>
                <td style="text-align:left;padding:5px;"><?php echo $Data['sequence_no']; ?>. <?php echo $Data['test_display_name']; ?> <br> <?php echo $Data['test_display_method']; ?></td></tr>
            </table>
