                            ...
                            <div class="card-header">
                                <div class="row mb-3">
                                    <div class="col-sm-4">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <input type="text" id="search_gc" class="form-control form-control-sm" value="<?php echo ($search_gc != 'NULL') ? $search_gc : ''; ?>" placeholder="SEARCH BY GC NO...">
                                            </div>
                                            <div class="col-sm-6">
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php if ($RS->total_record_finding == $RS->status_count) { ?>
                                                            ...
                                                            <?php } else { ?>
                                                                ...
                                                                <?php } ?>
                                                            <?php } ?>
                                                            <?php if ($RS->status == 'Report Approved' && $RS->revise_count < 4) { ?>
        ...
        <div class="modal-content modal-lg" style="margin: 0 auto;">
            ...
            <form name="final_report_generate" id="final_report_generate" method="post" action="<?php echo base_url(); ?>manage_lab/Final_report_generate">
                ...
                <div class="modal-body">
                    ...
                    <textarea name="part_details" id="part_details" cols="30" rows="10" class="ckeditor form-control">
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea name="email_body" id="" cols="30" rows="10" class="form-control ckeditor">
                                ...
                                <table width="100%" border="0" cellspacing="5" cellpadding="5" style="border-collapse:collapse; font-family:Arial, Helvetica, sans-serif;font-size:12px;">
                                    ...
                                    <tr>  <td colspan="2"> <b style="color: red;"> * </b> Your Password for the report is first four letters of your name and your email address after @.  </td></tr> <!-- added by millan on 06-07-2021 -->
    ...
    $('document').ready(function() {
        ...
        $('.final_report').click(function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    var part = '<table align="center" cellspacing="0" border="1" style="border-collapse:collapse; width:100%;"><thead><tr><th scope="col" style="vertical-align:bottom; white-space:nowrap; width:86px"><span style="font-size:15px"><span style="font-family:Calibri,sans-serif">TESTED COMPONENT</span></span></th><th scope="col" style="vertical-align:bottom; white-space:nowrap; width:96px"><span style="font-size:15px"><span style="font-family:Calibri,sans-serif">SAMPLE DESCRIPTION</span></span></th></tr></thead><tbody>';
                    var part1 = '</tbody></table>';
                    $.each(result.parts, function(key, val) {
                        part += '<tr><td align="center" style="border-bottom:1px solid black;text-align:center; border-left:1px solid black; border-right:1px solid black; border-top:none; height:19px; vertical-align:bottom; white-space:nowrap"><span style="font-size:15px"><span style="font-family:Calibri,sans-serif">' + val.part_name + '</span></span></td>' +
                            '<td  style="border-bottom:1px solid black; border-left:1px solid black; border-right:1px solid black; border-top:none; height:19px; vertical-align:bottom; white-space:nowrap"><span style="font-size:15px"><span style="font-family:Calibri,sans-serif">' + val.parts_desc + '</span></span></td></tr>';
                    });
                    part += part1;
        ...
        $(document).on('click', '.release_to_client', function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    var result = $.parseJSON(data); 
                    var cust_name = result.customer_name.substr(0,5); // added by millan on 06-july-2021
                    var email = result.email.split("@"); // added by millan on 06-july-2021
                    var password = cust_name + email[1]; // added by millan on 06-july-2021
                    if (result) {
