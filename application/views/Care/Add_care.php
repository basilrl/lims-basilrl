  ...
  <section class="content-header">
    ...
    <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="name1" required class="form-control" style="width: 100%;">
                      <?php echo form_error('name1', '<div class="text-danger">', '</div>'); ?>
                    </div>
</div>
<div class="col-md-6">
                    <div class="form-group">
                      <label>Instruction Type :</label>
                      <input type="text" name="type" required class="form-control" style="width: 100%;">
        ...
        <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="file" required  name="image"  class="form-control" style="width: 100%;">
      ...
      <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="wording" required class="form-control" style="width: 100%;">
          ...
          <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="order" required class="form-control" style="width: 100%;">
                  ...
                  <div class="form-group">
                           <center> <input type="submit" value="Submit" name="btnadd" class="btn btn-primary btn-lg">
