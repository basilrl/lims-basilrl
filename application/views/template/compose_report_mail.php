            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Release Report</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="<?php echo base_url('Released_report/send_report_mail/'.$sample_reg_id.'/'.$report_id)?>" method="post" id="send_acknowledgement_mail">
                            <div class="card-body">
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data.status > 0) {
                    ...
                    window.location.replace('<?php echo base_url("Released_report/released_report_listing")?>');
                } else {
