...
<head>
    ...
    <title>ISO Draft Test Report</title>
</head>
<style>
     @page {
...
<body>
    ...
    <div class="bg_image">
                ...
                <tr>
                    <td>
                        ...
                        <?php if ($report_data->nabl_record != 0) { ?>
                            <!-- Changed by Saurabh on 07-09-2021 -->
                            ...
                            <img src="https://cpslims-prod.s3.ap-south-1.amazonaws.com/format/nabl-ilac-logo.png" alt="" width="12%" style="text-align:left;margin-top:-23px;">
        ...
        <table style="font-size:14px;width:100%;">
            ...
            <?php } if(!empty($report_data->contact_name) && $report_data->contact_name!="") { ?>
                <tr>
                    <td>Contact Person</td>
                    <td>:</td>
                    <td><?php echo $report_data->contact_name; ?></td>
                </tr>
            <?php } if(!empty($report_data->address) && $report_data->address!="") { ?>
                <tr>
                    <td>Address</td>
                    <td>:</td>
