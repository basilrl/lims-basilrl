...
<head>
    ...
    <title>PACKAGING UAE REPORT</title>
</head>
<style>
    @page {
        ...
        <?php if ($image_sample) { ?>
            ...
            <?php } else { ?>
                ...
                <?php if ($report_data->remark) { ?>
                    ...
                    <div style="width: 100%; font-size:10px"><?php echo trim(html_entity_decode($report_data->remark)); ?></div>
                    </tr>
                <?php } ?>
                        ...
                        <?php foreach ($record_finding_data as $key => $Data) { ?>
                            ...
                            <?php if (!empty($Data['test_type'])) { ?>
                                ...
                                <?php if ($Data['non_nabl_headings'] && !empty($Data['non_nabl_headings'])) { ?>
                                    <table border="1" style="width:100%;border-collapse: collapse;font-size:10px;margin:0 auto; margin: bottom 20px;">
                                ...
                                <?php } ?>
                                <div class="nabl_non_nabl" style="font-family:cambria;width:100%;margin:0 auto;font-size:10px;padding:0; margin-bottom:20px">
