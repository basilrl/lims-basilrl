    ...
    <div class="bg_image">
        ...
        <htmlpagefooter name="myFooter">
            <table style="width: 100%;margin-right:-30px;margin-top:30px;">
                <tr>
                    <td style="text-align:center; font-size:11px">Reg. off : 642 Avanta Business Centre 6th Floor Park Centra
Sector 30 Gurgaon ,Pincode- 122001, India
                        <br>
                        www.basilrl.com
                    </td>
                </tr>
        ...
        <table style="width: 100%;">
            <tr>
                <th width="70%" align="left">Report No.: <?php echo $report_data->report_num; ?></th>
                <th width="30%" align="right">Dated: <?php echo date("d M Y", strtotime($report_data->issuance_date)); ?></th>
            </tr>
        ...
        <table style="font-size:14px;width:100%;">
            <?php if (!empty($report_data->customer_name)) { ?>
                <tr>
                    <td>Applicant</td>
                    <td>:</td>
                    <td><b><?php echo $report_data->customer_name; ?></b></td>
                </tr>
            <?php } ?>
        ...
        <?php if ($image_sample) { ?>
            <div class="sample_image noheader" style="page-break-inside: auto !important;">
                ...
                <table style="width: 100%;border-collapse:collapse;text-align:center;font-size:14px;" cellpadding="8">
                    <tr>
                        <?php $i = 1;
                        foreach ($image_sample as $key9 => $sample_photo) { ?>
                            <td style="text-align: center;">
                                <?php if (!empty($sample_photo->comment)) { ?>
                                    ...
                                    <br />
                                <?php } ?>
                                <img src="<?php echo $sample_photo->image_file_path; ?>" style="border:1px solid #333;width:320px;height:250px;">
                            </td>
                            <?php if ($i % 2 == 0) { ?>
                    </tr>
                    <tr>
                ...
                <table style="width: 100%;border-collapse:collapse;text-align:center;font-size:14px;" cellpadding="8">
                    <tr>
                        ...
                        foreach ($reference_sample as $key10 => $reference_photo) { ?>
                            <td style="text-align: center;">
                                <img src="<?php echo $reference_photo->image_file_path; ?>" style="border:1px solid #333;width:320px;height:250px;">
                            </td>
                            <?php if ($i % 2 == 0) { ?>
                    </tr>
                    <tr>
