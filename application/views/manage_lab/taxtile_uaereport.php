...
<head>
    ...
    <title>TEXTILE UAE REPORT</title>
</head>
<style>
    @page {
    ...
    <div class="bg_image">
        ...
        <?php if ($image_sample) { ?>
            ...
            <?php } else { ?>
                ...
                <br>
                <div style="width: 100%;text-decoration:underline;font-weight:bolder;font-size:10px;font-family:cambria;text-transform:uppercase;"><b> Sample Details as Provided by Customer:</b></div>
                <br>
                        ...
                        <?php foreach ($record_finding_data as $key => $Data) { ?>
                            <table style="text-transform:uppercase;width:100%;border-collapse:collapse;font-size:12px;margin:0 auto;" border="1">
                                ...
                                <?php if (!empty($Data['test_display_method'])) { ?>
                                    <tr>
                                        <td> <?php echo $Data['test_display_method']; ?></td>
                                    </tr>
                                <?php } ?>
                            </table>
