        ...
        <form id="manage_opportunity" name="manage_opportunity" action="javascript:void(0);">
          ...
          <div class="row p-2">
            ...
            <div class="col-sm-6">
              ...
              <textarea name="description" id="" cols="30" rows="3" class="form-control form-control-sm " minlength="200"></textarea>
            </div>
          </div>
...
<script>
  $(document).ready(function() {
    ...
    $('.customer_name').focus(function(e) {
      let where_array = JSON.stringify({
        'isactive': 'Active',
        <?php if(exist_val('Listing/branch_wise',$this->session->userdata('permission'))){ $checkUser = $this->session->userdata('user_data'); ?>
        'mst_branch_id': "<?php echo $checkUser->branch_id ?>"
        <?php } ?>
      });
      getAutolist('customer_id', 'customer_name', 'customer_list', 'customer_li',where_array , 'customer_name', 'customer_id as id,customer_name as name', 'cust_customers');
 ...
 <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Customers log</h5>
          <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
