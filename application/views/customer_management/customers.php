...
<div class="content-wrapper">
  ...
  <!--ADDED ON 23-08-2021 BY KAPRI-->  
           <div class="col-sm-8 bg-white" >
            <?php echo form_open_multipart('creditLimitUpdate', ['id' => 'creditLimitUpdate'])?>
            <div class="p-1 row  text-center"> 
               <div class="col-sm-5">
                     <input type="file" name="documents" class="form-control form-control-sm exporter" required>
                 </div>
                
                  <div class="col-sm-3">
                      <button id="import_submit_btn" type="submit" class="btn btn-success btn-sm">Import Credit Limit</button>
                 </div>
            ...
            <?php echo form_close();?>
              ...
              <div class="row">
                ...
                <div class="col-sm-2">
                  <select name="" class="form-control form-control-sm weekly_yes">
                    <?php echo ($weekly_yes) ? $weekly_yes : ""; ?>
                    <option value="">Sample Week Report</option>
                    <option value="1" <?php echo ($weekly_yes == '1') ? "selected" : ""; ?>>YES</option>
                    <option value="0" <?php echo ($weekly_yes == '0') ? "selected" : ""; ?>>NO</option>
                  </select>
                </div>
                <?php if ($created_by) {
                ...
                <div class="col-sm-2">
                <input title="START DATE" type="date" name="from_date" class="form-control form-control-sm from_date" placeholder="TO DATE" value="<?php echo ($from_date) ? $from_date : '' ?>">
                </div> <br> <br>
                <div class="col-sm-2">
                <input title="END DATE" type="date" name="to_date" class="form-control form-control-sm to_date" placeholder="END DATE" value="<?php echo ($to_date) ? $to_date : '' ?>">
                </div>
                <div class="col-sm-2">
            ...
            <div class="table-responsive small container-fluid">
              <table id="" class="table table-sm table-hovered" style="font-size: 10px;">
                <thead>
                  <tr>
                  ...
                  if ($to_date != "") {
                    ...
                    <th scope="col"><a href="<?php echo base_url('customer_management/Customers/index/' . $customer_id . '/' . $customer_type . '/' . $accope_customer . '/'. $weekly_yes . '/' . $created_by . '/' . $from_date . '/' . $to_date . '/' . $search . '/'  . base64_encode('cust.customer_name') . '/' . $order) ?>">CUSTOMER NAME</a></th>
                    <th scope="col"><a href="<?php echo base_url('customer_management/Customers/index/' . $customer_id . '/' . $customer_type . '/' . $accope_customer . '/'. $weekly_yes . '/' . $created_by . '/' . $from_date . '/' . $to_date . '/' . $search . '/'  . base64_encode('cust.customer_code') . '/' . $order) ?>">CUSTOMER CODE</a></th>
                    <th scope="col"><a href="<?php echo base_url('customer_management/Customers/index/' . $customer_id . '/' . $customer_type . '/' . $accope_customer . '/'. $weekly_yes . '/' . $created_by . '/' . $from_date . '/' . $to_date . '/' . $search . '/'  . base64_encode('cust.customer_type') . '/' . $order) ?>">CUSTOMER TYPE</a></th>
                    <th scope="col"><a href="<?php echo base_url('customer_management/Customers/index/' . $customer_id . '/' . $customer_type . '/' . $accope_customer . '/'. $weekly_yes . '/' . $created_by . '/' . $from_date . '/' . $to_date . '/' . $search . '/'  . base64_encode('cust.gstin') . '/' . $order) ?>">GSTIN</a></th>
                    <th scope="col"><a href="<?php echo base_url('customer_management/Customers/index/' . $customer_id . '/' . $customer_type . '/' . $accope_customer . '/'. $weekly_yes . '/' . $created_by . '/' . $from_date . '/' . $to_date . '/' . $search . '/'  . base64_encode('cust.email') . '/' . $order) ?>">EMAIL</a></th>
                    <th scope="col"><a href="<?php echo base_url('customer_management/Customers/index/' . $customer_id . '/' . $customer_type . '/' . $accope_customer . '/'. $weekly_yes . '/' . $created_by . '/' . $from_date . '/' . $to_date . '/' . $search . '/'  . base64_encode('country.country_name') . '/' . $order) ?>">COUNTRY</a></th>
                    <th scope="col"><a href="<?php echo base_url('customer_management/Customers/index/' . $customer_id . '/' . $customer_type . '/' . $accope_customer . '/'. $weekly_yes . '/' . $created_by . '/' . $from_date . '/' . $to_date . '/' . $search . '/'  . base64_encode('cust.telephone') . '/' . $order) ?>">TELEPHONE</a></th>
                    <th scope="col">NAV CUST CODE</th>
                    <th scope="col"><a href="<?php echo base_url('customer_management/Customers/index/' . $customer_id . '/' . $customer_type . '/' . $accope_customer . '/'. $weekly_yes . '/' . $created_by . '/' . $from_date . '/' . $to_date . '/' . $search . '/'  . base64_encode('cust.customer_type') . '/' . $order) ?>">ACCOP/NOT-ACCOP</a></th>

                    <th scope="col"><a href="<?php echo base_url('customer_management/Customers/index/' . $customer_id . '/' . $customer_type . '/' . $accope_customer . '/'. $weekly_yes . '/' . $created_by . '/' . $from_date . '/' . $to_date . '/' . $search . '/'   . base64_encode('cust.sample_week_report') . '/' . $order) ?>">SAMPLE REPORT WEEKLY</a></th>

                    <th scope="col"><a href="<?php echo base_url('customer_management/Customers/index/' . $customer_id . '/' . $customer_type . '/' . $accope_customer . '/'. $weekly_yes . '/' . $created_by . '/' . $from_date . '/' . $to_date . '/' . $search . '/'  . base64_encode('cust.created_by') . '/' . $order)?>">CREATED BY</a></th>
                    <th scope="col"><a href="<?php echo base_url('customer_management/Customers/index/' . $customer_id . '/' . $customer_type . '/' . $accope_customer . '/'. $weekly_yes . '/' . $created_by . '/' . $from_date . '/' . $to_date . '/' . $search . '/'  . base64_encode('cust.isactive') . '/' . $order) ?>">STATUS</a></th>
                    <th scope="col"><a href="<?php echo base_url('customer_management/Customers/index/' . $customer_id . '/' . $customer_type . '/' . $accope_customer . '/'. $weekly_yes . '/' . $created_by . '/' . $from_date . '/' . $to_date . '/' . $search . '/'  . base64_encode('cust.created_on') . '/' . $order) ?>">CREATED ON</a></th>
                ...
                <tbody>
                  ...
                  ?>
                      <tr>
                        ...
                        <td><?php echo $item->nav_customer_code; ?></td>
                        <td><?php echo ($item->accop_cust == '1') ? "MARKED" : "UN-MARKED" ?></td>
                        <td><?php echo ($item->sample_week_report == '1') ? "YES" : "NO" ?></td>
                        ...
                        <td>
                          ...
                          <?php if (exist_val('Customers/view_cust_details', $this->session->userdata('permission'))) { ?>
                            ...
                            <a class="btn btn-sm view_customers_details" title="View Customers Details" data-id="<?php echo $item->customer_id ?>" data-bs-toggle="modal" data-bs-target=".view_customer_dets" id="mark_notification">
                              <img src="<?php echo base_url('assets/images/view.png') ?>" alt="view customer">
                            </a>
                          <?php } ?>
                            <!--ADDED ON 24-08-2021 FOR PUSHING TO BUSINESS CENTRAL-->
                            <?php if (exist_val('Customers/view_cust_details', $this->session->userdata('permission'))) { ?>

                            <a hidden class="btn btn-sm" title="Push To Business Central" 
                               onclick="sendCustomerToBC('<?php echo $item->customer_id; ?>')">
                                <img width="20px;" src="<?php echo base_url('public/img/icon/add_Stock.png') ?>" alt="view customer">
                            </a>
                          <?php } ?>
                          ...
                          <?php if (exist_val('Customers/add_opportunity', $this->session->userdata('permission'))) { ?>
                            ...
                            <a data-id="<?php echo $item->customer_id ?>" data-bs-toggle="modal" data-bs-target=".add_opportunity" style="cursor:pointer" class="add_opportunity_new"><img src="<?php echo base_url('assets/images/edit_opportunity.png') ?>" alt="Add New Opportunity" title="Add Opportunity"></a>
                          <?php } ?>

                          <?php if (exist_val('Customers/load_oportunity', $this->session->userdata('permission'))) { ?>

                            <a data-id="<?php echo $item->customer_id ?>" data-bs-toggle="modal" data-bs-target=".manage_opportunity" style="cursor:pointer" class="manage_opportunity_btn"><img src="<?php echo base_url('assets/images/opportunity.png') ?>" alt="View Opportunity" title="View Opportunity"></a>
                          ...
                          <?php
                          if (exist_val('Customers/upload_customer_logo', $this->session->userdata('permission'))) { ?>

                            <button type="button" class="btn btn-sm  upload_sign" data-bs-toggle="modal" data-bs-target="#upload_signature" title="Upload Customer logo" data-id="<?php echo $item->customer_id ?>"><i class="fas fa-file-signature" alt='Upload Customer logo'></i>
                            </button>
                          <?php
                          } ?>

                          <?php if (exist_val('Customers/weekly_report', $this->session->userdata('permission'))) { ?>
                            <?php if ($item->sample_week_report > 0) { ?>
                              <a href="<?php echo base_url('customer_management/Customers/weekly_report/' . base64_encode($item->customer_id)); ?>" style="cursor:pointer" title="Get Weekly Sample Report"><img src="<?php echo base_url('assets/images/ok.png') ?>" alt="Get Weekly Sample Report" title="Get Weekly Sample Report"></a>
                            <?php } else { ?>
                              <a href="<?php echo base_url('customer_management/Customers/weekly_report/' . base64_encode($item->customer_id)); ?>" style="cursor:pointer" title="Get Weekly Sample Report"><img src="<?php echo base_url('assets/images/bullet_go.png') ?>" alt="Get Weekly Sample Report" title="Get Weekly Sample Report"></a>
                            <?php } ?>
                          <?php } ?>
                          ...
                          <!-- Added by Saurabh to upload credit acceptance file on 11-10-2021 -->
                          <a href="javascript:void(0)" class="upload_credit_doc" data-cust_id="<?php echo $item->customer_id; ?>" data-bs-toggle="modal" data-bs-target="#accredit_approve_doc"><img src="<?php echo base_url('assets/images/icon/uploaddocument.png')?>" alt="" width="20px"></a>

                          <?php if(!empty($item->credit_approved_doc)){?>
                            <a href="<?php echo base_url('customer_management/Customers/download_pdf?customer_id='.base64_encode($item->customer_id))?>" download=""><img src="<?php echo base_url('assets/images/download.gif')?>" alt="" width="20px"></a>
                          <?php } ?>

                          <!-- start upload logo vipin -->
                          <a href="javascript:void(0)" class="logo_path" data-cust_id="<?php echo $item->customer_id; ?>" data-bs-toggle="modal" data-bs-target="#logo_path" style="position:relative;top:4px;left:5px;" title="Upload Logo"><i class='fa fa-file-upload' style="font-size: 15px;"></i></a>
...
<div class="modal fade" id="upload_signature" tabindex="-1" role="dialog" aria-labelledby="upload_signature" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content modal" style="margin: 0px auto;">
      <div class="modal-header">
        <h5 class="modal-title" id="upload_imageLabel">UPLOAD CUSTOMER LOGO</h5>
...
<script>
  ...
  $(document).ready(function() {
    $('#form_upload_signature').submit(function(e) {
      ...
      $.ajax({
        url: '<?php echo base_url(); ?>customer_management/Customers/upload_customer_logo',
        contentType: false,
        processData: false,
        type: "post",
        async: true,
    ...
    $('.upload_sign').on('click', function() {
      ...
      $.ajax({
        url: "<?php echo base_url('customer_management/Customers/get_logo') ?>",
        method: "post",
        data: {
          _tokken: _tokken,
          customer_id: customer_id,
        ...
        success: function(data) {
          ...
          if (result) {
            ...
            $('.show_signature').html('<img style="max-height:250px" src="' + result + '" alt="">');
          } else {
            $('.show_signature').html('<h1>No Logo Found</h1>');
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="manage_contact" name="manage_contact" action="javascript:void(0);">
          ...
          <div class="row p-2">
            <div class="col-sm-6">
              <label for=""> <span class="text-danger">*</span> Contact Name:</label>
          ...
          <div class="row p-2">
            <div class="col-sm-6">
              <label for=""><span class="text-danger">*</span>Telephone:</label>
...
<script>
    function sendCustomerToBC(customer_id){
        
         var  csrf_hash = '<?= $this->security->get_csrf_hash();?>';
         swal({
         title: "Are you sure?",
         text: "Do you want to push customer to business central?",
         icon: "warning",
         buttons: true,
         dangerMode: true
        })
           ...
           if(release){
               $('body').append('<div class="pageloader"></div>');
                ...
                $.ajax(
                    {
                        type: "POST",
                        url: "<?php echo base_url('customer_management/customers/pushCustomerToBC'); ?>",
                        data: {customer_id : customer_id, _tokken : csrf_hash},
                        success: function(data){
                            ...
                            if(res.error){
                              ...
                              swal(res.error.message,"Something Went Wrong!", "error").then(() => {
                               ...
                               $('.pageloader').remove();
                                swal("Customer Added!", "success").then(() => {
                                location.reload();    
                             });
  ...
  function searchfilter() {
    ...
    var url = '<?php echo base_url("customer_management/Customers/index"); ?>';

    var customer_id = $('.customer_id').val();
    var customer_type = $('.customer_type').val();
    var accope_customer = $('.accope_customer').val();
    var weekly_yes = $('.weekly_yes').val();
...
<script>
  ...
  $(document).ready(function() {
    ...
    <?php if (exist_val('Branch/Wise', $this->session->userdata('permission'))) { ?>
      <?php $multBranch = $this->session->userdata('branch_ids'); ?>
      where_array['mst_branch_id IN (' + '<?php echo $multBranch; ?>' + ')'] = null;
    <?php } ?>
    ...
    $('.view_customers_details').on('click', function() {
      ...
      $.ajax({
        ...
        success: function(data) {
          ...
          row += "<tr>";
          row += "<td><b>CREDIT LIMIT</b></td>";
          row += "<td>" + customer.credit_limit + "</td>";
          row += "</tr>";
...
<!-- Added by saurabh on 11-01-2021 -->
<div class="modal fade" id="accredit_approve_doc" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content modal-sm">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Credit Approved Document Upload</h5>
        <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form action="<?php echo base_url('customer_management/customer/upload_credit_approve_doc')?>" id="upload_credit_approve_doc" method="post" enctype="multipart/form-data">
        <div class="modal-body">
          <input type="hidden" name="customer_id" class="customer_id">
          <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
            <div class="form-group">
              <label for="">Upload file</label>
              <input type="file" name="credit_approve_doc" class="form-control form-control-sm">
            </div>
...
<!-- start upload logo vipin -->
<div class="modal fade" id="logo_path" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content modal-sm">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Upload Customer Logo</h5>
        <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form action="<?php echo base_url('customer_management/customer/logo_path')?>" id="logo_path" method="post" enctype="multipart/form-data">
        <div class="modal-body">
          <input type="hidden" name="customer_id" class="customer_id">
          <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
            <div class="form-group">
              <label for="">Upload Logo</label>
              <input type="file" name="logo_path" class="form-control form-control-sm">
            </div>
            <img src="" id="upload_path_val" height="50px;">
...
<script>
  $(document).ready(function(){
    $('.upload_credit_doc').click(function(){
      var customer_id = $(this).data('cust_id');
      $('.customer_id').val(customer_id);
    });
    $(document).on("submit", "#upload_credit_approve_doc", function (e) {
      var form = $(this);
		e.preventDefault();
		$.ajax({
			url: "<?php echo base_url('customer_management/Customers/upload_credit_approve_doc')?>",
			type: "POST",
			processData: false,
			contentType: false,
          ...
          $.notify(data.message, "success");
				...
				if (data.error) {
					...
					$.each(error, function (i, v) {
						$('#upload_credit_approve_doc input[name="' + i + '"]').after('<span class="text-danger upload_invoice">' + v + "</span>");
...
<script>
  ...
  $(document).ready(function(){
    ...
    $('.logo_path').click(function(e){
       e.preventDefault();
       var customer_id = $(this).data('cust_id');
       $('.customer_id').val(customer_id);

        $.ajax({
          url: "<?php echo base_url('customer_management/Customers/get_logo_path')?>",
           data: {
          ...
          success: function(result) {           
            //console.log(data.logo_path);
             $('#upload_path_val').attr('src','');
            if (result.status > 0) {
                var fullImagePath = result.logo_path;
                $('#upload_path_val').attr('src', fullImagePath);
            } 
            else
            {
                 var fullImagePath = '';
    ...
    $(document).on("submit", "#logo_path", function (e) {
      var form = $(this);
		e.preventDefault();
		$.ajax({
			url: "<?php echo base_url('customer_management/Customers/logo_path')?>",
			type: "POST",
			processData: false,
			contentType: false,
			data: new FormData(this),
          ...
          setTimeout(function() {
              location.reload();
				...
				if (data.error) {
					var error = data.error;          
          $('#logo_path .upload_logo').remove();
          
					$.each(error, function (i, v) {
						$('#logo_path input[name="' + i + '"]').after('<span class="text-danger upload_logo">' + v + "</span>");
