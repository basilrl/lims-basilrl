        ...
        <table style="width:100%;text-align: left;">
            ...
            <tr>
                <td style="text-align: center;">
                    <img width="200px" height="80px" src="https://cpslims-prod.s3.ap-south-1.amazonaws.com/format/quote_logo.png" alt="">
                </td>
            </tr>
            ...
            <table class="test_table content" style="margin-top:0px;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <?php if (array_key_exists('show_discount', $data)) {
                            if ($data->show_discount) { ?>
                                <td><?php echo ($package_data['discount']) ? number_format((float)$package_data['discount'], 2, '.', '') : 0; ?></td>
                        <?php }
                        } ?>
