        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="row">
              ...
              <div class="col-md-3">
                <div class="form-group">
                  <select class="select-box" class="form-control form-control-sm" name="applicant_name" id="applicant_name">
                    <option selected value="">Select Applicant</option>
                    <?php if (!empty($customer)) { ?>
                      <?php foreach ($customer as $value) { ?>
                        <option value="<?php echo $value->customer_id; ?>" <?php if ($applicant == $value->customer_id) {
                                                                              echo "selected";
                                                                            } ?>><?php echo $value->customer_name; ?></option>
                      <?php } ?>
                    <?php } ?>
              ...
              <div class="col-md-3">
                <div class="form-group">
                  <select class="form-control form-control-sm" name="report_remark" id="report_remark">
                    <option value="" selected> Invoice Status</option>
                    <option value="2" <?php if ($invoice == '2') {
                                        echo 'selected';
                                      } ?>>Marked</option>
                    <option value="1" <?php if ($invoice == '1') {
                                        echo 'selected';
                                      } ?>>Un-Marked</option>
                  </select>
                </div>
            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body small p-0">
                  <table class="table table-hover table-sm" id="sample-list" style="font-size: 12px;">
                    <thead>
                      <tr>
                        <th>SL No.</th>
                      ...
                      <?php if (!empty($sample_registered)) {
                        ...
                        foreach ($sample_registered as $sample) { ?>
                          <tr>
                            ...
                            <td><?php echo $sample['applicant_name'] ? $sample['applicant_name'] : 'N/A'; ?></td>
                            <td><?php echo $sample['status']; ?></td>
                            <!-- <td><?php echo $sample['manual_report_remark']; ?></td> -->
                            <td><?php echo $sample['marked_invoice'] == '1' ? '<span style="color:red;">Un-Marked</span>' : '<span style="color:green;">Marked</span>'; ?></td>
                            ...
                            <td>
                              <?php if ($sample['status'] != "Login Cancelled") { ?>
                                <?php if (!empty($sample['buyer'])) { ?>
                                  <?php if ($sample['buyer_active'] == 'Active' && $sample['customer_active'] = 'Active' && $sample['status'] != "Hold Sample") { ?>
                                    <?php if (exist_val('SampleRegistrationEdit/edit_sample_reg', $this->session->userdata('permission'))) { ?>
                                      ...
                                      ?>
                                      <a href="<?php echo base_url('SampleRegistrationEdit?sample_reg_id=' . base64_encode($sample['sample_reg_id'])); ?>"><img src="<?php echo base_url('/public/img/icon/edit.png'); ?>" style="width: 20px;" title="Edit Sample Registration"></a>
                                      <?php //} 
                                      ?>
                                      <!--end by kapri-->
                                    <?php } ?>
                                    ...
                                    <!-- new marked invoice -->
                                    <?php if ($sample['marked_invoice'] == "1") {  ?>
                                      <?php //if (exist_val('SampleRegistration_Controller/markedInvoice', $this->session->userdata('permission'))) {
                                      ?>
                                      <a data-one=<?= $sample['sample_reg_id'] ?> href="Javascript:void(0)" class="markedInvoice"><i class="fa fa-flag" width="30px" title="Marked Invoice"></i></a>
                                      <?php // } 
                                      ?>
                                    <?php  } ?>
                                    ...
                                    // Added pi count condition to restrict further operation brfore poroforma generate by saurabh on 23-06-2021
                                    ...
                                    <?php if ($sample['pi_count'] == 1 && $sample['additional_flag'] == 1) { ?>
                                    ...
                                    <?php if (exist_val('SampleRegistration_Controller/webcam_images', $this->session->userdata('permission'))) { ?>
                                      <!-- added by Millan on 24-02-2021 -->
                                      <a href="javascript:void(0)" class="webcam_id" data-bs-toggle="modal" id="sample_image_upload1" data-bs-target="#web_upload_image" title="Upload Images using WEBCAM" data-one="<?php echo $sample['sample_reg_id']; ?>"><img src="<?php echo base_url('assets/images/webcam.png') ?>" alt="Upload Image" style="height:16px; width:16px;"></a>
                                    <?php } ?>
                                    <?php if (exist_val('SampleRegistration_Controller/sample_image_upload', $this->session->userdata('permission'))) { ?>
                                      <!-- added by Millan on 24-02-2021 -->
                                      <a href="javascript:void(0)" data-bs-toggle="modal" id="sample_image_upload" data-bs-target="#upload_image" title="Upload Images" data-one="<?php echo $sample['sample_reg_id']; ?>"><img src="<?php echo base_url('assets/images/image.png') ?>" alt="Upload Image" style="height:16px; width:16px;"></a>
                                    <?php } ?>
                                    ...
                                    <?php if ($sample['sample_registration_branch_id'] == 4) { ?>
                                      <?php if (exist_val('SampleRegistration_Controller/worksheet_dubai', $this->session->userdata('permission'))) { ?>
                                        <!-- added by Millan on 24-02-2021 -->
                                        <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#worksheetlab" class="worksheet_lab" title="Worksheet" data-one="<?php echo $sample['sample_reg_id']; ?>"><img src="<?php echo base_url('assets/images/worksheet.png') ?>" alt="Worksheet"></a>
                                      <?php } ?>
                                    <?php } else { ?>
                                      <?php if (exist_val('SampleRegistration_Controller/worksheet_all', $this->session->userdata('permission'))) { ?>
                                        <!-- added by Millan on 24-02-2021 -->
                                        <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#worksheet" id="show_worksheet" title="Worksheet" data-one="<?php echo $sample['sample_reg_id']; ?>"><img src="<?php echo base_url('assets/images/worksheet.png') ?>" alt="Worksheet"></a>
                                      <?php } ?>
                                    <?php } ?>
                                    <!-- Added by Saurabh on 19-02-2021 -->
                                    <?php if (exist_val('SampleRegistration_Controller/send_acknowledgement_mail', $this->session->userdata('permission'))) { ?>
                                      <!-- added by Millan on 24-02-2021 -->
                                      <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#barcode" id="show_barcode" title="Show Barcode" data-one="<?php echo $sample['sample_reg_id']; ?>"><img src="<?php echo base_url('assets/images/printer.png') ?>" alt="Printer"></a>
                                    <?php } ?>
                                    ...
                                    <?php if (($sample['qr_code_name'] == "") && empty($sample['qr_code_name'])) { ?>
                                      <?php if (exist_val('SampleRegistration_Controller/forward_sample_for_manual_reporting', $this->session->userdata('permission'))) { ?>
                                        <!-- added by Millan on 24-02-2021 -->
                                        <a href="javascript:void(0)" class="btn btn-sm manual_reporting_sample" title="Forward Sample for Manual Reporting" data-id="<?php echo $sample['sample_reg_id']; ?>"><img src="<?php echo base_url('assets/images/accept.png') ?>" alt="Forward Sample for Manual Reporting"></a>
                                      <?php } ?>
                                    <?php } else { ?>
                                      <?php if (!empty($sample['manual_report_file']) && $sample['manual_report_file'] != '') { ?>
                                        <?php if (exist_val('SampleRegistration_Controller/download_manual_report_pdf', $this->session->userdata('permission'))) { ?>
                                          <!-- added by Millan on 24-02-2021 -->
                                          <a href="javascript:void(0)" title="Show All Manual Report PDF" data-bs-toggle="modal" data-bs-target="#report_pdf" class="show_all_report_pdf" data-id="<?php echo $sample['sample_reg_id']; ?>"><img src="<?php echo base_url('assets/images/view.png') ?>" alt="Download Pdf From AWS" style="height:20px; width: 20px"></a>
                                      ...
                                      <?php } else { ?>
                                        ...
                                        <?php if (exist_val('SampleRegistration_Controller/upload_pdf_qr', $this->session->userdata('permission'))) { ?>
                                          <!-- added by Millan on 24-02-2021 -->
                                          <a href="javascript:void(0)" data-bs-toggle="modal" class="btn btn-sm manualreportpdf_upload" data-bs-target="#manual_report_pdf_upload" title="Upload Maunal Report PDF" data-id="<?php echo $sample['sample_reg_id']; ?>"><img src="<?php echo base_url('assets/images/upload_fl.png') ?>" alt="Upload Maunal Report PDF"></a>
                                        <?php } ?>
                                      <?php } ?>
                                    <?php } ?>
                                    ...
                                    <?php if ($sample['image_count'] > 0) { ?>
                                      <?php if (exist_val('SampleRegistration_Controller/view_sample_images', $this->session->userdata('permission'))) { ?>
                                        <!-- added by Millan on 24-02-2021 -->
                                        <a href="javascript:void(0)" data-bs-toggle="modal" id="sample_image" data-bs-target="#sample_images" title="View Sample Images" data-id="<?php echo $sample['sample_reg_id']; ?>"><img src="<?php echo base_url('public/img/icon/viewdetail.png') ?>" alt="View Images" style="height:16px; width:16px"></a>
                                      <?php } ?>
                                    <?php } ?>
                                    <!-- Added by Saurabh on 28-01-2021 -->
                                    ...
                                    <?php if (exist_val('SampleRegistration_Controller/sample_login_cancel', $this->session->userdata('permission'))) { ?>
                                      <!-- added by Millan on 24-02-2021 -->
                                      <a href="javascript:void(0)" data-bs-toggle="modal" id="login_cancel" data-bs-target="#logincancel" title="Login Cancel Sample" data-id="<?php echo $sample['sample_reg_id']; ?>"><img src="<?php echo base_url('assets/images/cancel.png') ?>" alt="Login Cancel Sample" style="height:16px; width:16px"></a>
                                    <?php } ?>
                                    <!-- Added by Saurabh on 08-02-2021 -->
                                    ...
                                    <a href="javascript:void(0)" data-bs-toggle="modal" class="hold_sample" data-bs-target="#hold_sample" title="Hold Sample" data-id="<?php echo $sample['sample_reg_id']; ?>"><img src="<?php echo base_url('assets/images/revise.png') ?>" alt="Hold Reason" style="height:16px; width:16px"></a>
                                    <a href="javascript:void(0)" data-bs-toggle="modal" class="reason_unhold" data-bs-target="#reason_unhold" title="Unhold Reason" data-id="<?php echo $sample['sample_reg_id']; ?>"><img src="<?php echo base_url('assets/images/page_white_text.png') ?>" alt="Unhold Reason" style="height:16px; width:16px"></a>
                                    <!-- Added by Saurabh on 23-06-2021 updated by millan on 30-06-2021-->
                                    <a href="javascript:void(0)" data-gc="<?php echo $sample['gc_no']; ?>" data-id="<?php echo $sample['sample_reg_id']; ?>" class="partial_report" data-bs-toggle='modal' data-bs-target='#partial_report_count' class="btn btn-sm" title="Generate Partial Report"><img src="<?php echo base_url('assets/images/finish_task.png'); ?>" alt="Generate Partial Report" width="18px"></a>

                                    <!-- Added by saurabh on 08-11-2021 to change sample status -->
                                    <?php if (exist_val('SampleRegistration_Controller/change_status', $this->session->userdata('permission'))) { ?>
                                      <a href="javascript:void(0)" data-id="<?php echo $sample['sample_reg_id']; ?>" class="change_status" data-bs-toggle='modal' data-bs-target='#changeStatus' class="btn btn-sm" title="Change Sample Status"><img src="<?php echo base_url('assets/images/edit_page_options.png'); ?>" alt="Log view" width="20px"></a>
                                    <?php } ?>
                                  ...
                                  <?php } else { ?>
                                    ...
                                    <a href="javascript:void(0)" data-bs-toggle="modal" class="reason_hold" data-bs-target="#hold_reason" title="Hold Reason" data-id="<?php echo $sample['sample_reg_id']; ?>"><img src="<?php echo base_url('assets/images/page_white_text.png') ?>" alt="Hold Reason" style="height:16px; width:16px"></a>
                                  <?php } ?>
                                  ...
                                  <?php } else { ?>
                                    ...
                                    <?php if (!empty($sample['manual_report_file']) && $sample['manual_report_file'] != '') { ?>
                                      ...
                                      <?php if (exist_val('SampleRegistration_Controller/download_manual_report_pdf', $this->session->userdata('permission'))) { ?>
                                        <!-- added by Millan on 24-02-2021 -->
                                        <!-- <a class="btn btn-sm" href="<?php echo base_url('SampleRegistration_Controller/download_pdf?sample_reg_id=' . base64_encode($sample['sample_reg_id'])); ?>" id="download_manualpdfaws" title="Download Manual Report Pdf" data-id="<?php echo $sample['sample_reg_id']; ?>"><img src="<?php echo base_url('assets/images/downloadpdf.png') ?>" alt="Download Pdf From AWS" style="height:20px; width: 20px"></a> -->
                                        <a href="javascript:void(0)" title="Show All Manual Report PDF" class="show_all_report_pdf" data-bs-toggle="modal" data-bs-target="#report_pdf" class="show_all_report_pdf" data-id="<?php echo $sample['sample_reg_id']; ?>"><img src="<?php echo base_url('assets/images/view.png') ?>" alt="Download Pdf From AWS" style="height:20px; width: 20px"></a>
                                      <?php } ?>
                                ...
                                <?php } ?>
                              <?php } ?>
                              <!-- Changed by Saurabh on 12-01-2022, to clone sample at any time -->
                              <!-- sample registration clone -->
                              <?php if (exist_val('SampleRegistration_Controller/clone_sample', $this->session->userdata('permission'))) { ?>
                                <!-- added by Millan on 24-02-2021 -->
                                <a id="sample_clone" href="javascript:void(0)" target="" data-id="<?php echo $sample['sample_reg_id']; ?>" data-trf_id="<?php echo $sample['trf_id']; ?>" data-bs-toggle="modal"><img src="<?php echo base_url(); ?>assets/images/active_res.png" alt="" title="Clone Sample"></a>
                              ...
                              <!-- <a href="javascript:void(0)" data-id="<?php echo $sample['sample_reg_id']; ?>" class="generate_barcode" class="btn btn-sm" title="Re-Generate Barcode"><img src="<?php echo base_url('assets/images/regenerate.png'); ?>" alt="Log view" width="20px"></a> -->
                            </td>
                          </tr>
                      <?php }
                      } else {
  ...
  <div class="modal fade" id="sampleClone" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content modal-lg" style="margin:0 auto;">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Sample Registration Clone</h5>
        ...
        <form action="javascript:void(0)" method="post" id="">
          <div class="modal-body">
            <div class="row">
              <input type="hidden" name="clone_sample_reg_id" class="clone_sample_reg_id">
              <input type="hidden" name="clone_trf_id" class="clone_trf_id">
              <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
              <div class="col-md-6">
                <div class="form-group">
                  <span class="error-msg" style="color: red;"></span><br />
                  <label for="">Select Service Type</label>
                  <select name="tat_date_clone" id="service_type_clone" class="form-control form-control-sm service_type_clone">
                    <option selected="" disabled>Choose Option</option>
                    <?php foreach ($service_type_data as $service_type_data_row) { ?>
                      <option value="<?php echo $service_type_data_row['service_type_id']; ?>"><?php echo $service_type_data_row['service_type_name']; ?></option>
                    <?php } ?>
                  </select>
                </div>
              </div>
              <div class="col-md-6 partial_report_count">
                <div class="form-group">
                  <span></span><br />
                  <label for="">Due Date</label>
                  <input type="date" min="1" name="tat_date_clone" class="form-control form-control-sm tat_date_clone" value="">
                </div>
              </div>
          ...
          <div class="modal-footer">
            ...
            <button type="submit" class="btn btn-primary" id="new_sample_clone">Save changes</button>
          </div>
        </form>
      </div>
    </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-md-3">Test Method</div>
            <div class="col-md-9">
              <div class="form-group">
                <select name="test_method" id="test_method"></select>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="modal-body">
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                ...
                <select name="manual_report_result" class="form-control form-control-sm" id="result_upload_manual">
                  ...
                  <option value="3">Refer Result</option>
                </select>
              </div>
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                ...
                <textarea name="manual_report_remark" id="manual_report_remark" class="form-control form control-sm"></textarea>
              </div>
            </div>
            <div class="row">
              <div class="col-sm-6">
                <h6>Report Date:</h6>
                <input type="date" name="generated_date" value="<?php echo date('Y-m-d', time()) ?>" class="form-control form control-sm">
              </div>
              <div class="col-sm-6">
                <h6>Result Ready Date:</h6>
                <input type="date" name="mr_result_ready_date" value="<?php echo date('Y-m-d', time()) ?>" class="form-control form control-sm">
              </div>
            </div>
            <div class="row">
              <div class="col-sm-6">
  ...
  <!-- Modal to ask for partial report or revise report generate added by millan on 30-06-2021 -->
  <div class="modal fade" id="partial_report_count" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content modal-lg" style="margin:0 auto;">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Partial or Revise Report Generate</h5>
          <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <form action="javascript:void(0)" method="post" id="partial_report">
          <div class="modal-body">
            <div class="row">
              <input type="hidden" name="sample_reg_id" class="sample_reg_id">
              <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <select name="report_type" id="partial_report_generate" class="form-control form-control-sm">
                    <option selected="" disabled>Choose Option</option>
                    <option value="1">Revise Report</option>
                    <option value="2">Partial Report</option>
                  </select>
                </div>
              </div>
              <div class="col-md-6 partial_report_count">
                <div class="form-group">
                  <label for="">Basil Report NO.</label>
                  <input type="text" min="1" name="gc_number" class="form-control form-control-sm gc_number" placeholder="BASIL REPORT NUMBER" value=""> <!-- updated by millan on 30-06-2021  -->
                </div>
              </div>
              <div class="col-md-12">
                <div class="form-group">
                  <label for="">Reason:</label>
                  <textarea class="form-control form-control-sm report_reason" rows="5" cols="10" name="report_reason" placeholder="Please Specify Reason"></textarea>
                </div>
              </div>
            </div>
          </div>
  ...
  $(document).ready(function(){
    $('.partial_report').click(function(){
      var sample_reg_id = $(this).data('id');
      $('#partial_report_count .sample_reg_id').val(sample_reg_id);
    });

    $('#partial_report_generate').change(function(){
      var option = $(this).val();
      if(option == 1){
        $('.partial_report_count').css('display','block');
      } else{
        $('.partial_report_count').css('display','none');
      }
    });

    $('#partial_report').submit(function(e) {
      e.preventDefault();
        ...
        success: function(data) {
          ...
          if (data.error) {
              $.each(data.error, function(i, v) {
                  $('#partial_report input[name="' + i + '"]').after('<span class="text-danger errors_msg">' + v + '</span>');
                  $('#partial_report select[name="' + i + '"]').after('<span class="text-danger errors_msg">' + v + '</span>');
                  // $('#submit').html('Save');
  ...
  <script>
    $(document).ready(function() {
      $('.generate_barcode').click(function() {
        ...
        $.ajax({
          type: 'post',
          url: "<?php echo base_url('SampleRegistration_Controller/generate_barcode'); ?>",
          data: {
            _tokken: _tokken,
    ...
    $(document).ready(function() {
      $('.partial_report').click(function() {
        var sample_reg_id = $(this).data('id');
        var gc_number = $(this).data('gc'); // added by millan on 30-06-2021
        $('#partial_report_count .sample_reg_id').val(sample_reg_id);
        $('#partial_report_count .gc_number').val(gc_number); // added by millan on 30-06-2021
      });
      ...
      /* updated by millan on 30-06-2021 for report type */
      $(document).on("submit", "#partial_report", function(e) {
        e.preventDefault();
        var getdata = new FormData(this);
        $.ajax({
          url: "<?php echo base_url('SampleRegistration_Controller/save_partial_report_status'); ?>",
          data: $(this).serialize(),
          type: 'post',
          success: function(result) {
            $('.form_errors').remove();
            ...
            if (data.error) {
              $.each(data.error, function(i, v) {
                $('#partial_report input[name=' + i + ']').after('<span class="text-danger form_errors">' + v + '</span>');
                $('#partial_report select[name=' + i + ']').after('<span class="text-danger form_errors">' + v + '</span>');
                $('#partial_report textarea[name=' + i + ']').after('<span class="text-danger form_errors">' + v + '</span>');
              });
            }
          }
        });
      ...
      /* updated by millan on 30-06-2021 */
  ...
  <script>
    $(document).ready(function() {
      ...
      /**------------------------clone sample------// sample clone changes---------- */
      $(document).on('click', '#sample_clone', function() {
        if (confirm("Do you want to clone this Sample ? Please confirm?")) {
          ...
          $('.clone_trf_id').val(trf_id);
          $('.clone_sample_reg_id').val(sample_id);
          $('#sampleClone').modal('show');
        } else {
          return false;
        }
      });
      $('.service_type_clone').on('change', function() {
        var service_type = $('.service_type_clone').val();
        var service_type_text = $('.service_type_clone option:selected').text();
        $.ajax({
          type: 'post',
          url: "<?php echo base_url('SampleRegistration_Controller/getDueDateByServiceType'); ?>",
          data: {
            _tokken: _tokken,
          ...
          success: function(data) {
            ...
            console.log(data);
            $('.tat_date_clone').val('');
            let due_date = $('.tat_date_clone').val(data.data);
          }
        })
      ...
      $(document).on('click', '#new_sample_clone', function() {
        const _tokken = $('meta[name="_tokken"]').attr('value');
        var trf_id = $('.clone_trf_id').val();
        var sample_id = $('.clone_sample_reg_id').val();
        var tat = $('.tat_date_clone').val();
        var service_type = $('.service_type_clone').val();
        console.log(service_type);

        if (service_type == '' || service_type == null) {
          $('.error-msg').text('Service Type is required.');
          setTimeout(function() {
            $('.error-msg').fadeOut();
          }, 3000);
          return false;
  ...
  <script>
    ...
    function filter(page) {
      ...
      if (report_remark == "") {
        ...
        report_remark = ($('#report_remark').val());
      }
      var enddue = $('#enddue').val();
      if (enddue == "") {
        enddue = null;
      } else {
        enddue = ($('#enddue').val());
      }
      var startdue = $('#startdue').val();
      if (startdue == "") {
        startdue = null;
      } else {
  ...
  <!-- Modal to show all report PDF -->
  <div class="modal fade" id="report_pdf" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content modal-sm">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Download Report PDF</h5>
          <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
  ...
  <script>
    $(document).ready(function() {
      const url = $('body').data('url');
      const _tokken = $('meta[name="_tokken"]').attr('value');
      $('.show_all_report_pdf').click(function() {
        $('.pdf_list').empty();
        var sample_reg_id = $(this).data('id');
        $.ajax({
          url: '<?php echo base_url('SampleRegistration_Controller/get_all_report_pdf') ?>',
          type: 'post',
          data: {
            _tokken: _tokken,
            sample_reg_id: sample_reg_id
          ...
          success: function(data) {
            ...
            html += '<thead>';
            html += '<tr><th>S. No.</th>'
            html += '<th>PDF Link</th></tr>'
            html += '</thead>';
            sno = 1;
            $.each(data, function(i, v) {
              html += '<tr>';
              html += '<td>' + sno + '</td>'
              html += '<td><a href="' + url + 'SampleRegistration_Controller/download_pdf/?sample_reg_id=' + btoa(v.sample_reg_id) + '&report_id=' + btoa(v.report_id) + '" target="_blank"><img src="<?php echo base_url('assets/images/downloadpdf.png') ?>" alt="Download Pdf From AWS" style="height:20px; width: 20px"></a></td>';
              html += '</tr>';
              sno++;
            });
            html += '</table>';
  ...
  <div class="modal fade" id="changeStatus" tabindex="-1" role="dialog" aria-labelledby="changeStatusLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content modal-md">
        <div class="modal-header">
          <h5 class="modal-title" id="changeStatusLabel">Change Sample Status</h5>
          <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <form action="<?php echo base_url('SampleRegistration_Controller/change_status'); ?>" method="post" id="change_status">
          <div class="modal-body">
            <input type="hidden" name="sample_reg_id" class="sample_reg_id">
            <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
            <div class="form-group">
              ...
              <select name="sample_status" id="sample_status" class="form-control">
                ...
                <option value="Sample Sent for Evaluation">Sample Sent for Evaluation</option>
                <option value="Report Generated">Report Generated</option>
                <option value="Send For Record Finding">Send For Record Finding</option>
                <option value="Registered">Registered</option>
                <option value="Sample Accepted">Sample Accepted</option>
                <option value="Completed">Completed</option>
                <option value="Retest">Retest</option>
                <option value="Report Rejected">Report Rejected</option>
                <option value="Sample Sent to Reporting">Sample Sent to Reporting</option>
                <option value="Evaluation Completed">Evaluation Completed</option>
                <option value="Login Cancelled">Login Cancelled</option>
  ...
  <script>
    ...
    $('.markedInvoice').on('click', function() {
      let id = $(this).data('one');
      let userConfirmed = confirm("Do you really want to Marked Invoice?");
      const _tokken = $('meta[name="_tokken"]').attr('value');
      if (userConfirmed) {
        $.ajax({
          url: '<?php echo base_url('SampleRegistration_Controller/markedInvoice'); ?>',
          type: 'post',
          data: {
            _tokken: _tokken,
            sample_reg_id: id
          ...
          success: function(data) {
            ...
            if (res.status > 0) {
              jQuery.notify(res.message, "success");
              window.setTimeout(function() {
                window.location.reload();
              }, 2000);
            } else {
              jQuery.notify(res.message, "error");
            }
          }
        });
      } else {
