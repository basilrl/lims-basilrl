                    ...
                    <select class="select-box" class="form-control form-control-sm" name="product" id="product">
                      ...
                      <?php if (!empty($products)) {
                        foreach ($products as $value) { ?>
                          <option value="<?php echo $value['sample_type_id']; ?>" <?php if($product_name == $value['sample_type_id']){ echo "selected";}?>><?php echo $value['sample_type_name'] ?></option>
                      <?php }
                      } ?>
                    </select>
                  </div>
                    ...
                    <select class="select-box" class="form-control form-control-sm" name="customer_name" id="customer_name">
                      ...
                      <?php if (!empty($customer)) {
                        foreach ($customer as $value) { ?>
                          <option value="<?php echo $value['customer_id']; ?>" <?php if($customer_id == $value['customer_id']){ echo "selected";}?>><?php echo $value['customer_name'] ?></option>
                      <?php }
                      } ?>
                    </select>
                  </div>
                    ...
                    <select class="select-box" class="form-control form-control-sm" name="buyer" id="buyer">
                      ...
                      <?php if (!empty($buyer)) {
                        foreach ($buyer as $value) { ?>
                          <option value="<?php echo $value['customer_id']; ?>" <?php if($buyer_id == $value['customer_id']){ echo "selected";}?>><?php echo $value['customer_name'] ?></option>
                      <?php }
                      } ?>
                    </select>
                  </div>
                    ...
                    <select class="select-box" class="form-control form-control-sm" name="division" id="division">
                      ...
                      <?php if (!empty($division)) {
                        foreach ($division as $value) { ?>
                          <option value="<?php echo $value['division_id']; ?>" <?php if($division_id == $value['division_id']){ echo "selected";}?>><?php echo $value['division_name'] ?></option>
                      <?php }
                      } ?>
                    </select>
                  </div>
                    ...
                    <select class="select-box" class="form-control form-control-sm" name="status" id="status">
                      ...
                      <?php if (!empty($sample_status)) {
                        foreach ($sample_status as $value) { ?>
                          <option value="<?php echo $value['status']; ?>" <?php if($status == $value['status']){ echo "selected";}?>><?php echo $value['status'] ?></option>
                      <?php }
                      } ?>
                    </select>
                  </div>
                      ...
                      foreach ($sample_registered as $sample) { ?>
                        <tr>
                          ...
                          <td><?php
                            ...
                            <?php
                              } elseif($sample['status'] == "Registered") {
...
<!-- end -->
                            ...
                            $sampleStatus=array(
                                ...
                                'Report Approved',
                                'Sample Sent to Reporting',
                                'Sample Sent for Manual Reporting');
                              if (in_array($sample['status'],$sampleStatus) && $sample['status'] != "Proforma Generated") { ?> 
                            ...
                            <a href="javascript:void(0)" id="send_email" title="Resend Sample Acknowledgeent Mail" data-one="<?= $sample['sample_reg_id']; ?>" data-two="sample_registration" onclick="confirm('Are you sure want to send acknowledgement mail again!.')"><img src="<?php echo base_url('assets/images/send_email.png') ?>" alt="Send Email"></a>
                            ...
                            <?php if (($sample['qr_code_name'] == "") && empty($sample['qr_code_name'])) { ?>
                              <a href="javascript:void(0)" class="btn btn-sm manual_reporting_sample" title="Forward Sample for Manual Reporting" data-id="<?= $sample['sample_reg_id']; ?>"><img src="<?php echo base_url('assets/images/accept.png') ?>" alt="Forward Sample for Manual Reporting"></a>
                            <?php }else{ ?>
  ...
  const _tokken = $('meta[name="_tokken"]').attr('value');
        if (confirm("Do you want to clone this Sample ? Please confirm?")) {
            ...
            $.ajax({
                ...
                data: { _tokken: _tokken, trf_id : trf_id, sample_id : sample_id },
                dataType: 'json',
                success: function(data) {
