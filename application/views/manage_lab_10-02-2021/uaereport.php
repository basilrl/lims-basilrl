...
<body>
        ...
        <htmlpageheader name="myHeader">
            <table style="margin-top:-20px;width:100%;">
                <tr>
                    ...
                    <td style="text-align: center;font-size:24px;font-weight:600;text-decoration:underline;">
                        TEST REPORT
                    </td>
                ...
                <tr>
                    <th style="text-align: left;" colspan="2">Test Report No.: <?php echo $report_data->report_num; ?></th>
    ...
    <?php } ?> <br>
    <div style="border: 1px solid black;padding:5px;">Remark : <?php echo trim(html_entity_decode($report_data->remark)); ?></div>
